...
export var FormComponent = function (_a) {
    ...
    return (_jsxs("form", __assign({ onSubmit: handleSubmit(onFormComplete) }, { children: [fields.map(function (_a, index) {
                var name = _a.name, placeholder = _a.placeholder, type = _a.type, validation = _a.validation, label = _a.label, options = _a.options, types = _a.types;
                {
                    switch (type) {
                        case 'file':
                            return (_jsxs(FormControl, __assign({ pt: "15px", isInvalid: errors[name] }, { children: [_jsx(Text, __assign({ __css: styles === null || styles === void 0 ? void 0 : styles.inputLabel, color: '#000000', fontSize: '16px' }, { children: label })), _jsx(FileUploader, { id: "fileUploader", handleChange: function (ev) { return setValue(name, ev); }, name: "file", types: types, label: "Drag or Click here to upload", multiple: false }), _jsx(FormErrorMessage, { children: errors.name && errors.name.message })] }), index));
                        case 'string':
                            return (_jsxs(FormControl, __assign({ pt: "15px", isInvalid: errors[name] }, { children: [_jsx(Text, __assign({ __css: styles === null || styles === void 0 ? void 0 : styles.inputLabel, color: '#000000', fontSize: '16px' }, { children: label })), _jsx(Input, __assign({ id: name, placeholder: placeholder, __css: styles === null || styles === void 0 ? void 0 : styles.input, _hover: styles['input:hover'], _focus: styles['input:focus'], _focusWithin: styles['input:focusWithin'], _active: styles['input:active'], _visited: styles['input:visited'], borderRadius: 0, padding: '12px 20px', fontSize: '12px' }, register(name, validation))), _jsx(FormErrorMessage, { children: errors.name && errors.name.message })] }), index));
                        case 'password':
                            return (_jsxs(FormControl, __assign({ pt: "15px", isInvalid: errors[name] }, { children: [_jsx(Text, __assign({ __css: styles.inputLabel, color: '#000000', fontSize: '16px' }, { children: label })), _jsx(Input, __assign({ type: "password", id: name, placeholder: placeholder, __css: styles.input, _hover: styles['input:hover'], _focus: styles['input:focus'], _focusWithin: styles['input:focusWithin'], _active: styles['input:active'], _visited: styles['input:visited'], borderRadius: 0, padding: '12px 20px', fontSize: '12px' }, register(name, validation))), _jsx(FormErrorMessage, { children: errors.name && errors.name.message })] }), index));
                        case 'select':
                            return (_jsxs(FormControl, __assign({ pt: "15px", isInvalid: errors[name] }, { children: [_jsx(Text, __assign({ __css: styles === null || styles === void 0 ? void 0 : styles.inputLabel, color: '#000000', fontSize: '16px' }, { children: label })), _jsx(Select, __assign({ id: name, variant: "filled", placeholder: placeholder }, register(name, validation), { children: _jsx(_Fragment, { children: options === null || options === void 0 ? void 0 : options.map(function (option, key) {
                        ...
                        case 'color':
                            return (_jsxs(FormControl, __assign({ pt: "15px", isInvalid: errors[name] }, { children: [_jsx(Text, __assign({ __css: styles === null || styles === void 0 ? void 0 : styles.inputLabel, color: '#000000', fontSize: '16px' }, { children: label })), _jsx(ColorPicker, { onColorPick: function (color) {
                                            setValue(name, color);
                                        } }), _jsx(FormErrorMessage, { children: errors.name && errors.name.message })] }), index));
                        default:
                            break;

...
export var ColorPicker = function (_a) {
    ...
    return (_jsx(Center, __assign({ marginTop: 5 }, { children: _jsxs(Popover, __assign({ variant: "picker" }, { children: [_jsx(PopoverTrigger, { children: _jsx(Button, { "aria-label": color, background: color, height: "22px", width: "22px", padding: 0, minWidth: "unset", borderRadius: 3 }) }), _jsxs(PopoverContent, __assign({ width: "170px" }, { children: [_jsx(PopoverArrow, { bg: color }), _jsx(PopoverCloseButton, { color: "white" }), _jsx(PopoverHeader, __assign({ height: "100px", backgroundColor: color, borderTopLeftRadius: 5, borderTopRightRadius: 5, color: "white" }, { children: _jsx(Center, __assign({ height: "100%" }, { children: color })) })), _jsx(PopoverBody, __assign({ height: "240px" }, { children: _jsx(SimpleGrid, __assign({ columns: 5, spacing: 2 }, { children: colors.map(function (c) { return (_jsx(Button, { "aria-label": c, background: c, height: "22px", width: "22px", padding: 0, minWidth: "unset", borderRadius: 3, _hover: { background: c }, onClick: function () {
                                        setColor(c);
                                    } }, c)); }) })) }))] }))] })) })));
};

...
export var WidgetComponent = function (props) {
    ...
    return (_jsx(ChakraProvider, { children: isLoading ? _jsx(Spinner, { thickness: "6px", size: "xl", style: {
                ...
                top: 'calc(50% - 4em)',
                left: 'calc(50% - 4em)',
            } }) : widgetSettings && product && partner && styles && (_jsxs(Modal, __assign({ closeOnOverlayClick: false, isOpen: isOpen, onClose: onClose, isCentered: true, motionPreset: "scale", size: 'sm' }, { children: [_jsx(ModalOverlay, { backdropFilter: "blur(10px) hue-rotate(90deg)" }), _jsxs(ModalContent, __assign({ __css: styles === null || styles === void 0 ? void 0 : styles.root, borderRadius: 0 }, { children: [_jsx(ModalHeader, { children: _jsx("b", __assign({ style: styles === null || styles === void 0 ? void 0 : styles.title }, { children: "Please enter your credentials" })) }), _jsx(ModalCloseButton, {}), _jsx(ModalBody, { children: _jsx(FormComponent, { fields: GET_FORM_FIELDS(product, partner), onFormComplete: onFormComplete, styles: styles }) })] }))] }))) }));
};

...
export var WidgetComponent = function (props) {
    ...
    return (_jsx(_Fragment, { children: widgetSettings && (_jsxs(Modal, __assign({ closeOnOverlayClick: false, isOpen: isOpen, onClose: onClose, isCentered: true, motionPreset: "scale", size: 'sm' }, { children: [_jsx(ModalOverlay, { backdropFilter: "blur(10px) hue-rotate(90deg)" }), _jsxs(ModalContent, __assign({ borderRadius: 0 }, { children: [_jsx(ModalHeader, { children: _jsx("b", { children: "Please enter your credentials" }) }), _jsx(ModalCloseButton, {}), _jsx(ModalBody, { children: _jsx(FormComponent, { fields: WIDGET_FORM_FIELDS, onFormComplete: onFormComplete, isLoading: isLoading, styles: styles }) })] }))] }))) }));
};

...
var EMPLOYMENT_TRUEWORK_FIELDS = [
    {
...
var EMPLOYMENT_TRUEWORK_INSTANT_FIELDS = [
    {
...
var EMPLOYMENT_PINWHEEL_FIELDS = [
    {
...
var EMPLOYMENT_MERIDIAN_FIELDS = [
    {
...
var EMPLOYMENT_FINICITY_FIELDS = [
    {
...
export var GET_FORM_FIELDS = function (product, partner) {
    switch (product) {
        case 'Employment':
            switch (partner) {
                case 'Equifax':
